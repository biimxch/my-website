...
export default function Hero() {
  return (
    <>
      {/* Load Pinyon Script from Google Fonts */}
      <style>{`
      ...
      >
        ...
        <FadeIn delay={0.2}>
          <div className="flex items-start justify-between mt-12 pt-6 ">
            ...
            {/* Left: Contact */}
            <div>
              <p className="text-lg font-bold text-[#334FAE] uppercase tracking-widest mb-3">
                Contact
              </p>
              ...
              <div className="flex flex-col gap-1 mb-4">
                <a
                  ...
                  className="text-lg text-stone-600 hover:text-[#334FAE] transition-colors duration-200"
                >
                  {personal.email}
                </a>
                <a
              ...
              <div className="flex items-center gap-3">
                {personal.github && (
                  <a
                    ...
                    aria-label="GitHub"
                    className="w-9 h-9 rounded-full bg-[#334FAE] flex items-center justify-center text-white hover:opacity-80 transition-all duration-300 hover:-translate-y-1"
                  >
            ...
            <div className="text-right self-end">
              <p className="text-sm font-bold text-[#334FAE] uppercase tracking-widest">
                Bangkok, Thailand
              </p>
            </div>
